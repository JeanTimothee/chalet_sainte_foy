...
booking1 = Booking.create!(chalet_id: chalet.id, start_date: Date.new(2020,12,5), end_date: Date.new(2020,12,12), name: "Régis")
booking2 = Booking.create!(chalet_id: chalet.id, start_date: Date.new(2020,12,19), end_date: Date.new(2020,12,26), name: "P-E")
